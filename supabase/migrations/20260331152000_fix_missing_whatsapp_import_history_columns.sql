-- Hotfix: garantir colunas de importacao de historico em whatsapp_instances
-- Alguns ambientes podem ter o registro da migration sem as colunas fisicamente aplicadas.
...
COMMENT ON COLUMN public.whatsapp_instances.import_history_enabled IS
  'Define se a instancia pode importar mensagens historicas ao conectar/reconectar.';

COMMENT ON COLUMN public.whatsapp_instances.import_history_days IS
  'Limite de dias para importar historico quando import_history_enabled = true.';
